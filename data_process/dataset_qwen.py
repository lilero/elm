...
if __name__ == "__main__":
    ...
    image_folder_path = "Risk_Classification"  # 图像文件夹路径
    label_file_path = "/root/autodl-tmp/Data/train_aug.txt"    # 你的标签文件路径
    output_json_path = "Risk_Classification.json"  # 输出的 JSON 文件名
