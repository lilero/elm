from vllm_inf import load_model, get_model_output
...
def argparser():
    ...
    parser.add_argument('--prompt', default='/root/Qwen2.5-VL/Evaluate/prompt/risk_classification.txt', type=str)  # 消防风险提示语
    ...
    parser.add_argument('--model_path', default="/root/autodl-tmp/Qwen/Qwen/Qwen2.5-VL-7B-Instruct-fine-tuning", type=str)
